...
class ServiceForm(FlaskForm):
    service_title = StringField('Service title', validators=[InputRequired()])
    service_city = StringField('City', validators=[InputRequired()])
    ...
    mobile_phone = StringField('Phone Number', validators=[InputRequired()])
