...
class ExtraForm(FlaskForm):
    photo = FileField('Upload submission documents only', validators=[FileRequired(), FileAllowed(images, 'Documents only!')])
    requirement_one = SelectField(u'Do you meet this requirement?', choices=[('Yes', 'Yes'), ('No', 'No')])
    requirement_two = SelectField(u'Do you meet this requirement?', choices=[('Yes', 'Yes'), ('No', 'No')])
    requirement_three = SelectField(u'Do you meet this requirement?', choices=[('Yes', 'Yes'), ('No', 'No')])
    requirement_four = SelectField(u'Do you meet this requirement?', choices=[('Yes', 'Yes'), ('No', 'No')])
    requirement_five = SelectField(u'Do you meet this requirement?', choices=[('Yes', 'Yes'), ('No', 'No')])
    requirement_six = SelectField(u'Do you meet this requirement?', choices=[('Yes', 'Yes'), ('No', 'No')])
    requirement_seven = SelectField(u'Do you meet this requirement?', choices=[('Yes', 'Yes'), ('No', 'No')])
    requirement_eight = SelectField(u'Do you meet this requirement?', choices=[('Yes', 'Yes'), ('No', 'No')])
    requirement_nine = SelectField(u'Do you meet this requirement?', choices=[('Yes', 'Yes'), ('No', 'No')])
    requirement_ten = SelectField(u'Do you meet this requirement?', choices=[('Yes', 'Yes'), ('No', 'No')])
    submit = SubmitField('Submit')
...
class InterestForm(FlaskForm):
    ...
    interest_two = StringField('Promo Opportunities')
