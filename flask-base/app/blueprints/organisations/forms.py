...
from wtforms.validators import DataRequired, Length, Required, ValidationError, InputRequired, Email, Optional
...
class OrganisationForm(FlaskForm):
    org_name = StringField('Organisation name', validators=[Required(), Length(1, 64)])
...
class PositionForm(FlaskForm):
    ...
    position_city = StringField('City', validators=[InputRequired()])
    position_state = SelectField(u'Select State in Nigeria', choices=[
        ('Outside Nigeria','Outside Nigeria'),
        ('Abia State', 'Abia State'),
        ('Adamawa State', 'Adamawa State'),
        ('Akwa Ibom State', 'Akwa Ibom State'),
...
class PromoForm(FlaskForm):
    ...
    promo_city = StringField('City', validators=[InputRequired()])
    promo_state = SelectField(u'Select State in Nigeria', choices=[
        ('Outside Nigeria','Outside Nigeria'),
        ('Abia State', 'Abia State'),
        ('Adamawa State', 'Adamawa State'),
        ('Akwa Ibom State', 'Akwa Ibom State'),
